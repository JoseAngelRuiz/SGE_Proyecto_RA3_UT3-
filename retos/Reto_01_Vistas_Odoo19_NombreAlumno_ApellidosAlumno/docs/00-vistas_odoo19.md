...
1. Activa **Developer Mode** (Preferencias → Activar modo desarrollador).
   ![](../assets/img/00-Modo_desarrollador/desarrollo.png)
...
![](../assets/img/01-list/vista1.png)

![](../assets/img/01-list/vista2.png)
...
**Capturas**:
![Search](../assets/img/04-search/buscar.png "Search/Filtros")

![Search](../assets/img/04-search/buscardev.png)
...
**Capturas**:
![Graph](../assets/img/06-graph/graf.png "Graph")
...
![QWeb Report](../assets/img/14-qweb/qweb2.png "Reporte QWeb")
